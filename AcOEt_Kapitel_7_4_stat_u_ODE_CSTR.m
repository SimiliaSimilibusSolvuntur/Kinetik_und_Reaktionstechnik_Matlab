...
%
% Dimensionieurng des CSTR-Reaktors gemäss Kapitel 7.4. Fallstudie Ethylacetat. 
%
% Der Reaktor ist am Anfang mit Lösungsmittel gefüllt.
%
% Bedienung zur Dimensionierung (ohne Performance-Gleichung):
%
% # Variieren Sie die Verweilzeit tau, bis Sie im stationären
% Zustand den gewünschten Umsatz von X_A = z.B. 90% erreichen. 
%       -> tau = ...; 
% # Durch manuelle Iteration finden Sie 108 Minuten als die gewünschte Verweilzeit. 
% Der stationäre Zustand stellt sich dann allerdings erst nach ca. 10 Stunden ein.
% Verlängern Sie deshalb die Simulationszeit auf 10 Stunden: 
%       -> t_end = 10*3600; 
%
% _A. Zogg, 04.05.2021_
...
%% Kapitel 7.4.2: Anwendung der Performance Gleichungen zum stationären CSTR-Reaktor 
...
X_A_f = X_A_out; % [-] Umsatz bezüglich Komponente A 
