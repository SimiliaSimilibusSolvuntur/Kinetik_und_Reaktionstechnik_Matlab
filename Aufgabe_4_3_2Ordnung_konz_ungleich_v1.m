% Aufgabe 4.3 Chemische Kinetik und Reaktionstechnik
% autor = Luca Moschen 
% date = 12.03.2021
...
c_B_0 = 1; % [mol/L] Anfangskonzentration
...
c_B = (c_B_0 * (c_B_0 - c_A_0) * exp((c_B_0 - c_A_0) * k_2AB * t)) ./...
      (c_B_0 * exp((c_B_0 - c_A_0) * k_2AB * t) - c_A_0); 
c_A = c_A_0 - (c_B_0 - c_B);
