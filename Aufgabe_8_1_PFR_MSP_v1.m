...
V_R_1 = Cap_CR * 1000 * tau_1 / 3600 / (c_A_in*mw_Prod*Verf* X_A_f) * 1000 * a/c; %[l]
disp(['V_R_1 = ', num2str(V_R_1/1000, '%.2g'), ' m3']);
mw_Prod = mw_i(4); % Molmasse des Produktes, Komponente "D"
V_R_2 = Cap_CR * 1000 * tau_1 / 3600 / (c_A_in*mw_Prod*Verf* X_A_f) * 1000 * a/d; %[l]
disp(['V_R_2 = ', num2str(V_R_2/1000, '%.2g'), ' m3']);
V_R = V_R_2;
...
plot(Sim.l, Sim.c_l_i(:, 1), 'k-', 'linewidth', 2);132
...
title(['3: Reaktion im PFR mit $d_R$ = ', num2str(d_R, '%.2g'), ...
...
ylabel('Konzentrationen $c_{i}$ [mol/l]', 'interpreter', 'latex');
title(['3: Reaktion im PFR bei 25 °C']);
yyaxis right
